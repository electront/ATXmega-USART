...
typedef struct {
	unsigned char list[TAMMAX];  // Arreglo para almacenar los elementos de la cola
	uint8_t ini;           // Índice del primer elemento en la cola
	uint8_t fin;           // Índice del último elemento en la cola
	uint8_t count;         // Número actual de elementos en la cola
} Buffer_s;
